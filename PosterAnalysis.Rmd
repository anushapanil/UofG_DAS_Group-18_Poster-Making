...
# Putting the Index column first2
bodyfat <- bodyfat %>%
  relocate(Index)
...
# My measurements
bendata <- data.frame(Abdomen=81,Weight=167,Wrist=15)

# Predicts me to have bodyfat ~14% albeit with a wide interval 
predict(threemodel,bendata,interval="predict")
